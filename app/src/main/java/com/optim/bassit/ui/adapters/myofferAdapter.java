...
public class myofferAdapter extends RecyclerView.Adapter<myofferAdapter.ViewHolder> {
    ...
    public myofferAdapter(ItemClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view;
            ...
            view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.myoffer_item, viewGroup, false);
    ...
    public void fill(int page, List<HomeadsFeed> homeFeeds) {
        if (page == 1)
            mData.clear();
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(HomeadsFeed home) {
           ...
           //     ImageView plan_img = itemView.findViewById(R.id.plan_img);
                if(homefeed.getTypereq()==null || homefeed.getTypereq().trim().isEmpty())type.setVisibility(GONE);
                ...
                if (homefeed.getDate_start() == null){
                    try {
                        ...
                        dateStart.setText(calendar.get(Calendar.YEAR) + "-" + calendar.get(Calendar.MONTH) + "-" + calendar.get(Calendar.DAY_OF_MONTH) + " -");
                    }catch (ParseException e) {
                        e.printStackTrace();
                    }

                }else{
                    dateStart.setText(homefeed.getDate_start() + " - ");
                }

                if (homefeed.getUnity() == null){
                    unity.setText(R.string.not_specified);
                }else{
                ...
                if (CurrentUser.getInstance().getmCustomer().getOfficial_account() == 1){
                    img_official_account.setVisibility(View.VISIBLE);
                }else{
                    img_official_account.setVisibility(GONE);
                }

                TextView st = itemView.findViewById(R.id.st);
                TextView datefin = itemView.findViewById(R.id.tdatefin);

                username.setText(homefeed.getFullName());
                String tst="";
                if(homefeed.getStatereq().equals("3")) tst=itemView.getContext().getString(R.string.non_finie);
                try {

                    Date date1=new SimpleDateFormat("yyyy-MM-dd").parse(homefeed.getDurationreq());
                    ...
                    if(diffInDays<0) tst=itemView.getContext().getString(R.string.finish);
                } catch (ParseException e) {
                    e.printStackTrace();
                }
                if(homefeed.getStatereq().equals("1")) tst=itemView.getContext().getString(R.string.fini_suc);
                if(homefeed.getStatereq().equals("2")) tst=itemView.getContext().getString(R.string.fini_witout_suc);

                if(homefeed.getStatereq().equals("4")) tst=itemView.getContext().getString(R.string.en_cour_tratment);

                st.setText(tst);
                datefin.setText(homefeed.getDurationreq());
            ...
            //    t_city.setTextColor(itemView.getContext().getResources().getColor(R.color.colorPrimaryDark));
              ...
              /*  if (homefeed.getTags() != null) {
                ...
                LinearLayout bst = itemView.findViewById(R.id.b_st);
            ...
            //    else {
                   // bmessage.setOnClickListener(view -> mListener.onMessageClick(home));
                    bmessage.setVisibility(GONE);
                    card.setOnClickListener(view -> mListener.onMessageClick(home));
                    brem.setOnClickListener(view -> mListener.onrmoveClick(home));
                    brem.setVisibility(View.VISIBLE);
                bst.setOnClickListener(view -> mListener.onstClick(home));
                bst.setVisibility(View.VISIBLE);
                if(homefeed.getStatereq().equals("4")) bst.setVisibility(GONE);
               // }
    ...
    public interface ItemClickListener {
        void onrmoveClick(HomeadsFeed HomeadsFeed);
        void onMessageClick(HomeadsFeed HomeadsFeed);
        void onstClick(HomeadsFeed HomeadsFeed);
    }
}
